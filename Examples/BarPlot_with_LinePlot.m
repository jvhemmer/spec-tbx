% BarPlot_with_LinePlot: Plot simple bar plot overlaid with line/scatter.
%
%   THE WILSON LAB
%   
...
expName = 'FE and NumPlot isothermal';
...
% CO Isothermal data
CO_I_FE = [14.992 20.372 20.632 17.8 21.972]; 
CO_STD_I_FE = [5.387551 9.13645 8.555979 8.258583 13.3592]; 
% CO_I_N = [0.108 0.1866 0.19 0.146 0.148]; 
% CO_STD_I_N = [0.027749 0.072061 0.056125 0.04827 0.078867]; 

% H2 Isothermal data
H2_I_FE = [30.646	29.174	29.394	34.554	38.282];
H2_STD_I_FE = [6.524188072	8.52568355 5.326854607	8.079036452	6.774195155];
% H2_I_N = [0.33 0.214 0.23 0.318 0.354];
% H2_STD_I_N = [0.127279 0.136858 0.072801 0.12276 0.118448];
...
% b1(1).BarLayout = 'stacked';
% b1(2).BarLayout = 'stacked';
b1(1).LineWidth = 1.5;
b1(2).LineWidth = 1.5;
b1(1).BarWidth = 0.8;
b1(2).BarWidth = 0.8;
